  ...
  return (
    <div className={styles['performance-dashboard']}>
      <div className={styles['performance-dashboard__header']}>
        ...
        <button onClick={() => setIsVisible(false)} className={styles['performance-dashboard__close']}>
          ×
        </button>
      </div>
      ...
      <div className={styles['performance-dashboard__summary']}>
        ...
        <div className={styles['performance-dashboard__metric']}>
          ...
          <span className={`${styles['performance-dashboard__value']} ${styles['performance-dashboard__value--good']}`}>
            {summary.goodMetrics}
          </span>
        </div>
        ...
        <div className={styles['performance-dashboard__metric']}>
          ...
          <span className={`${styles['performance-dashboard__value']} ${styles['performance-dashboard__value--warning']}`}>
        ...
        <div className={styles['performance-dashboard__metric']}>
          ...
          <span className={`${styles['performance-dashboard__value']} ${styles['performance-dashboard__value--error']}`}>
            {summary.poorMetrics}
          </span>
        </div>
      </div>
      ...
      <div className={styles['performance-dashboard__metrics']}>
        ...
        {metrics.slice(-10).map((metric, index) => (
          <div key={index} className={styles['performance-dashboard__metric-item']}>
            ...
            <span className={styles['performance-dashboard__metric-value']}>{metric.value.toFixed(2)}ms</span>
            {metric.rating && (
              <span
